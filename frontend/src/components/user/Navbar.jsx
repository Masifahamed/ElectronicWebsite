...
//   return (
//     <nav
//       className="bg-white text-gray-500 shadow-md py-4 flex justify-between gap-20 items-center relative z-20 h-25 px-6 lg:px-20" // Fixed duplicate px classes
//       ref={headerRef}
//     >
//       {/* Logo */}
...
//           className="w-35 h-35 object-cover sm:w-15 md:w-15 cursor-pointer" // Added cursor-pointer here too
//           onClick={() => handleNavigation("/")} // Make logo clickable to go home
//         />
//       </div>
...
//           >
//             <ul className="flex flex-col items-center py-10 space-y-4 bg-white z-50 text-2xl font-medium">
//               {navItems.map((item) => {
//                 const isActive = location.pathname === item.path;
//                 return (
//                   <li
//                     key={item.name}
//                     className={mobilenavlink(isActive)}
//                     onClick={() => handleNavigation(item.path)}
//                   >
//                     {item.name}
//                   </li>
...
//   const { isAuthenticated, user, logout, isUser, isAdmin } = useAuth();
...
//     { name: "Wishlist", path: "/wishlist", icon: <Heart className="h-5 w-5" />, requiresAuth: true },
//     { name: "Profile", path: "/profile", icon: <User className="h-5 w-5" />, requiresAuth: true },
//     { name: "Product", path: "/product", icon: <ShoppingBag className="h-5 w-5" /> }
//   ];
...
//               {isAdmin() && (
//                 <li
//                   className="cursor-pointer py-2 flex text-sm gap-1 items-center justify-center text-white bg-purple-600 hover:bg-purple-700 transition rounded-full px-4 py-2"
...
//               {/* User Welcome Message - Only show for regular users */}
//               {isUser() && (
//                 <li className="flex items-center gap-2 text-gray-700">
//                   <User className="h-4 w-4 text-blue-500" />
//                   <span className="text-sm font-medium">
//                     Welcome, <span className="text-blue-600">{getUserFirstName()}</span>
//                   </span>
//                 </li>
//               )}
...
//                   <li
//                     className="cursor-pointer py-2 flex gap-2 items-center justify-center text-white bg-purple-600 hover:bg-purple-700 transition rounded-full px-4 py-2 w-48"
//                     onClick={() => {
//                       navigate('/adminpage');
//                       setIsOpen(false);
//                     }}
